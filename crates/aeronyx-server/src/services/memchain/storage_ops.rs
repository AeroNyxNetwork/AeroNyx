...
pub(super) fn read_record_commitment_tip_transaction(
...
pub(super) async fn persist_record_commitment_tip_anchor(
    path: PathBuf,
    tip_height: u64,
    tip_hash: [u8; 32],
    identity: &IdentityKeyPair,
...
pub(super) fn read_sqlite_durability(
    connection: &rusqlite::Connection,
...
pub(super) fn ensure_full_sqlite_durability(
    connection: &rusqlite::Connection,
) -> Result<(i64, &'static str), String> {
...
impl MemoryStorage {
    ...
    pub(super) fn note_effective_sqlite_durability(&self, level: i64) {
...
impl MemoryStorage {
    ...
    pub(super) fn fail_record_commitment_tip_anchor(
        &self,
        state: &'static str,
        anchored_height: u64,
        write_failure: bool,
